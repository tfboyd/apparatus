...
python3 tf_cnn_benchmarks/tf_cnn_benchmarks.py --data_format=NCHW \
          ...
          --nodistortions --gradient_repacking=2 --datasets_use_prefetch=False \
          --train_dir=/output --summary_verbosity=1 --save_summaries_steps=100 \
          --num_epochs=81 --local_parameter_device=gpu --num_gpus=8 \
          --display_every=10 --xla_compile=True --datasets_use_caching=True \
